...
class Metaclass_Sum(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from tutorial_interfaces.srv import _sum
...
class Sum(metaclass=Metaclass_Sum):
    from tutorial_interfaces.srv._sum import Sum_Request as Request
    from tutorial_interfaces.srv._sum import Sum_Response as Response
